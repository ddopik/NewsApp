...
package com.codecourt.ddopikmain.seedapplication.app.Presenter.Volly.View;
//Unfortunately volley doesn’t provide any callback method once the NetworkImageView is loaded.
// So I created a custom ImageView class with callback methods.
// This class automatically adjusts the image height to prevent image aspect ratio distortion.
...
public class SingleNewsImageView extends ImageView {
    ...
    public SingleNewsImageView(Context context) {
        this(context, null);
    }

    public SingleNewsImageView(Context context, AttributeSet attrs) {
...
//     */
    ...
    private void loadImageIfNecessary(final boolean isInLayoutPass) {
        ...
        boolean isFullyWrapContent = getLayoutParams() != null
                && getLayoutParams().height == AbsListView.LayoutParams.WRAP_CONTENT
                && getLayoutParams().width == AbsListView.LayoutParams.WRAP_CONTENT;
